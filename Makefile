...
clean:
	...
	$(Q)-rm -f Simulations/BridgeTest/*_m.cc Simulations/BridgeTest/*_m.h Simulations/BridgeTest/*_sm.cc Simulations/BridgeTest/*_sm.h
	$(Q)-rm -f Simulations/Parameters/*_m.cc Simulations/Parameters/*_m.h Simulations/Parameters/*_sm.cc Simulations/Parameters/*_sm.h
	$(Q)-rm -f Simulations/Parameters/MAC/*_m.cc Simulations/Parameters/MAC/*_m.h Simulations/Parameters/MAC/*_sm.cc Simulations/Parameters/MAC/*_sm.h
	$(Q)-rm -f Simulations/Parameters/PhysicalProcess/*_m.cc Simulations/Parameters/PhysicalProcess/*_m.h Simulations/Parameters/PhysicalProcess/*_sm.cc Simulations/Parameters/PhysicalProcess/*_sm.h
	$(Q)-rm -f Simulations/Parameters/Radio/*_m.cc Simulations/Parameters/Radio/*_m.h Simulations/Parameters/Radio/*_sm.cc Simulations/Parameters/Radio/*_sm.h
	$(Q)-rm -f Simulations/Parameters/SensorDevice/*_m.cc Simulations/Parameters/SensorDevice/*_m.h Simulations/Parameters/SensorDevice/*_sm.cc Simulations/Parameters/SensorDevice/*_sm.h
	$(Q)-rm -f Simulations/Parameters/WirelessChannel/*_m.cc Simulations/Parameters/WirelessChannel/*_m.h Simulations/Parameters/WirelessChannel/*_sm.cc Simulations/Parameters/WirelessChannel/*_sm.h
	$(Q)-rm -f Simulations/Parameters/WirelessChannel/BANmodels/*_m.cc Simulations/Parameters/WirelessChannel/BANmodels/*_m.h Simulations/Parameters/WirelessChannel/BANmodels/*_sm.cc Simulations/Parameters/WirelessChannel/BANmodels/*_sm.h
	$(Q)-rm -f Simulations/connectivityMap/*_m.cc Simulations/connectivityMap/*_m.h Simulations/connectivityMap/*_sm.cc Simulations/connectivityMap/*_sm.h
	$(Q)-rm -f Simulations/radioTest/*_m.cc Simulations/radioTest/*_m.h Simulations/radioTest/*_sm.cc Simulations/radioTest/*_sm.h
	$(Q)-rm -f Simulations/simpleAggregation/*_m.cc Simulations/simpleAggregation/*_m.h Simulations/simpleAggregation/*_sm.cc Simulations/simpleAggregation/*_sm.h
	$(Q)-rm -f Simulations/valuePropagation/*_m.cc Simulations/valuePropagation/*_m.h Simulations/valuePropagation/*_sm.cc Simulations/valuePropagation/*_sm.h
	$(Q)-rm -f Simulations/valueReporting/*_m.cc Simulations/valueReporting/*_m.h Simulations/valueReporting/*_sm.cc Simulations/valueReporting/*_sm.h
	$(Q)-rm -f bin/*_m.cc bin/*_m.h bin/*_sm.cc bin/*_sm.h
	$(Q)-rm -f src/*_m.cc src/*_m.h src/*_sm.cc src/*_sm.h
	$(Q)-rm -f src/helpStructures/*_m.cc src/helpStructures/*_m.h src/helpStructures/*_sm.cc src/helpStructures/*_sm.h
	$(Q)-rm -f src/node/*_m.cc src/node/*_m.h src/node/*_sm.cc src/node/*_sm.h
	$(Q)-rm -f src/node/application/*_m.cc src/node/application/*_m.h src/node/application/*_sm.cc src/node/application/*_sm.h
	$(Q)-rm -f src/node/application/bridgeTest/*_m.cc src/node/application/bridgeTest/*_m.h src/node/application/bridgeTest/*_sm.cc src/node/application/bridgeTest/*_sm.h
	$(Q)-rm -f src/node/application/connectivityMap/*_m.cc src/node/application/connectivityMap/*_m.h src/node/application/connectivityMap/*_sm.cc src/node/application/connectivityMap/*_sm.h
	$(Q)-rm -f src/node/application/simpleAggregation/*_m.cc src/node/application/simpleAggregation/*_m.h src/node/application/simpleAggregation/*_sm.cc src/node/application/simpleAggregation/*_sm.h
	$(Q)-rm -f src/node/application/throughputTest/*_m.cc src/node/application/throughputTest/*_m.h src/node/application/throughputTest/*_sm.cc src/node/application/throughputTest/*_sm.h
	$(Q)-rm -f src/node/application/valuePropagation/*_m.cc src/node/application/valuePropagation/*_m.h src/node/application/valuePropagation/*_sm.cc src/node/application/valuePropagation/*_sm.h
	$(Q)-rm -f src/node/application/valueReporting/*_m.cc src/node/application/valueReporting/*_m.h src/node/application/valueReporting/*_sm.cc src/node/application/valueReporting/*_sm.h
	$(Q)-rm -f src/node/communication/*_m.cc src/node/communication/*_m.h src/node/communication/*_sm.cc src/node/communication/*_sm.h
	$(Q)-rm -f src/node/communication/mac/*_m.cc src/node/communication/mac/*_m.h src/node/communication/mac/*_sm.cc src/node/communication/mac/*_sm.h
	$(Q)-rm -f src/node/communication/mac/baselineBanMac/*_m.cc src/node/communication/mac/baselineBanMac/*_m.h src/node/communication/mac/baselineBanMac/*_sm.cc src/node/communication/mac/baselineBanMac/*_sm.h
	$(Q)-rm -f src/node/communication/mac/bypassMac/*_m.cc src/node/communication/mac/bypassMac/*_m.h src/node/communication/mac/bypassMac/*_sm.cc src/node/communication/mac/bypassMac/*_sm.h
	$(Q)-rm -f src/node/communication/mac/mac802154/*_m.cc src/node/communication/mac/mac802154/*_m.h src/node/communication/mac/mac802154/*_sm.cc src/node/communication/mac/mac802154/*_sm.h
	$(Q)-rm -f src/node/communication/mac/tMac/*_m.cc src/node/communication/mac/tMac/*_m.h src/node/communication/mac/tMac/*_sm.cc src/node/communication/mac/tMac/*_sm.h
	$(Q)-rm -f src/node/communication/mac/tunableMac/*_m.cc src/node/communication/mac/tunableMac/*_m.h src/node/communication/mac/tunableMac/*_sm.cc src/node/communication/mac/tunableMac/*_sm.h
	$(Q)-rm -f src/node/communication/radio/*_m.cc src/node/communication/radio/*_m.h src/node/communication/radio/*_sm.cc src/node/communication/radio/*_sm.h
	$(Q)-rm -f src/node/communication/routing/*_m.cc src/node/communication/routing/*_m.h src/node/communication/routing/*_sm.cc src/node/communication/routing/*_sm.h
	$(Q)-rm -f src/node/communication/routing/bypassRouting/*_m.cc src/node/communication/routing/bypassRouting/*_m.h src/node/communication/routing/bypassRouting/*_sm.cc src/node/communication/routing/bypassRouting/*_sm.h
	$(Q)-rm -f src/node/communication/routing/multipathRingsRouting/*_m.cc src/node/communication/routing/multipathRingsRouting/*_m.h src/node/communication/routing/multipathRingsRouting/*_sm.cc src/node/communication/routing/multipathRingsRouting/*_sm.h
	$(Q)-rm -f src/node/mobilityManager/*_m.cc src/node/mobilityManager/*_m.h src/node/mobilityManager/*_sm.cc src/node/mobilityManager/*_sm.h
	$(Q)-rm -f src/node/mobilityManager/lineMobilityManager/*_m.cc src/node/mobilityManager/lineMobilityManager/*_m.h src/node/mobilityManager/lineMobilityManager/*_sm.cc src/node/mobilityManager/lineMobilityManager/*_sm.h
	$(Q)-rm -f src/node/mobilityManager/noMobilityManager/*_m.cc src/node/mobilityManager/noMobilityManager/*_m.h src/node/mobilityManager/noMobilityManager/*_sm.cc src/node/mobilityManager/noMobilityManager/*_sm.h
	$(Q)-rm -f src/node/resourceManager/*_m.cc src/node/resourceManager/*_m.h src/node/resourceManager/*_sm.cc src/node/resourceManager/*_sm.h
	$(Q)-rm -f src/node/sensorManager/*_m.cc src/node/sensorManager/*_m.h src/node/sensorManager/*_sm.cc src/node/sensorManager/*_sm.h
	$(Q)-rm -f src/physicalProcess/*_m.cc src/physicalProcess/*_m.h src/physicalProcess/*_sm.cc src/physicalProcess/*_sm.h
	$(Q)-rm -f src/physicalProcess/carsPhysicalProcess/*_m.cc src/physicalProcess/carsPhysicalProcess/*_m.h src/physicalProcess/carsPhysicalProcess/*_sm.cc src/physicalProcess/carsPhysicalProcess/*_sm.h
	$(Q)-rm -f src/physicalProcess/customizablePhysicalProcess/*_m.cc src/physicalProcess/customizablePhysicalProcess/*_m.h src/physicalProcess/customizablePhysicalProcess/*_sm.cc src/physicalProcess/customizablePhysicalProcess/*_sm.h
	$(Q)-rm -f src/wirelessChannel/*_m.cc src/wirelessChannel/*_m.h src/wirelessChannel/*_sm.cc src/wirelessChannel/*_sm.h
